...
# --------------------------------------------------------------------
# 4. Layout: drei Spalten (links = Sidebar, mitte = Main, rechts = Pseudo-Sidebar)
# --------------------------------------------------------------------
